...
{{- $resourceGroupName          := printf "rg-%s-%s-%s-%s-%s" $clusterName $clusterHash $sanitisedRegion $specName $uniqueFingerPrint }}
...
{{- $virtualNetworkName          := printf "vn-%s-%s-%s-%s-%s" $clusterName $clusterHash $sanitisedRegion $specName $uniqueFingerPrint }}
