...
{{- $vpcName          := printf "vpc-%s-%s-%s-%s-%s" $clusterName $clusterHash $region $specName $uniqueFingerPrint }}
...
{{- $internetGatewayName          := printf "gtw-%s-%s-%s-%s-%s" $clusterName $clusterHash $region $specName $uniqueFingerPrint }}
...
{{- $routeTableName          := printf "rt-%s-%s-%s-%s-%s" $clusterName $clusterHash $region $specName $uniqueFingerPrint }}
...
{{- $securityGroupName          := printf "sg-%s-%s-%s-%s-%s" $clusterName $clusterHash $region $specName $uniqueFingerPrint }}
